...
CONFIG_FILE_PATH = Path("us_used_cars_ml_pipeline/config/config.yaml")

# Path to the parameters file which may contain hyperparameters, model training settings, etc.
PARAMS_FILE_PATH = Path("us_used_cars_ml_pipeline/params.yaml")

# Path to the schema file which may contain data schema definitions, validation rules, etc.
SCHEMA_FILE_PATH = Path("us_used_cars_ml_pipeline/schema.yaml")
