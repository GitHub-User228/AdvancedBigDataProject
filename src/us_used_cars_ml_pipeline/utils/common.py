...
def get_spark_session(app_name="us_used_cars_app"):
    ...
    """
    return SparkSession.builder.appName(app_name).config('spark.executor.memory', '11g').getOrCreate()
...
# @ensure_annotations
# def read_data_from_hdfdsfsds(df: DataFrame, spark: SparkSession, hdfs_path: str, chunksize):
#     pass 